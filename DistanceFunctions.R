...
DistanceCoordsFunction(WorkerDistScaled)
FullDataCoord
WorkerDistScaled
...
DistanceCoordsFunctionRD2(WorkerDistScaledRD2)
FullDataCoordRD2

view(WorkerDistScaledRD2)
...
BroodDistScaled %>% filter(Density == "Low")
